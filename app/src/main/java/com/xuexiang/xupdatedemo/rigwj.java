...
public class rigwj {
    public static String loginByGet(String username){
        try {
            //提交数据到服务器
            //拼装路径
            String path = "http://49.234.95.95:8080/Demo/rigwj?username="
...
//            return null;
    ...
    public static String loginByGetwj(String username){
        try {
            //提交数据到服务器
            //拼装路径
            String path = "http://49.234.95.95:8080/Demo/querrywj?username="
                    + URLEncoder.encode(username,"UTF-8");
            URL url = new URL(path);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();//打开连接
...
//            return null;
    ...
    public static String loginByPost(String username,String password,String tel){
        try {
            String path = "http://49.234.95.95:8080/Demo/rig?username="
